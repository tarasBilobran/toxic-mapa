...
menu = [
    [
        InlineKeyboardButton(
            text="🔎 Мапа отруєнь Львів та околиці.", callback_data="generate_map"
        ),
    ],
    [
        InlineKeyboardButton(
    ...
    [
        InlineKeyboardButton(
            text="🆘 Моя собака постраждала від отруєння.", callback_data="help_dog"
        ),
    ],
    [
        InlineKeyboardButton(
            text="☣️ Симптоми отруєння", callback_data="describe_symptoms"
        ),
    ],
    [
        InlineKeyboardButton(
            text="☎️ Контакти цілодобових вет-клінік.", callback_data="contacts"
        )
    ],
]
